...
export default function Earnings() {
  ...
  const cuttOffOptions = [
    ...
    { value: "1", label: "Basic" },
    { value: "2", label: "PERA" },
    { value: "3", label: "Laundry Allowance" },
    { value: "4", label: "Subsistence" },
    { value: "5", label: "Hazard Pay" },
    { value: "6", label: "Clothing Allowance" },
    { value: "7", label: "Representation Allowance" },
    { value: "8", label: "Collective Negotiation Aggreement" },
    { value: "9", label: "Longevity" },
    { value: "10", label: "Philhealth Honorarium" },
    { value: "11", label: "Performance Enhancement Incentive" },
    { value: "12", label: "Year End Bonus" },
    { value: "13", label: "Transportation Allowance" },
    { value: "14", label: "Mid-Year Bonus" },
    { value: "15", label: "Salary Adjustment" },
    { value: "16", label: "DOH Allowance" },
    { value: "17", label: "Meal Allowance" }
    ];
  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <div className="space-y-6">
                <ComponentCard title="Search Earnings">
                  <div className="flex items-center gap-6">
                   ...
                   <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-6">
                        <Label htmlFor="input" className="w-32">Income Type</Label>
                          <div className="flex items-center gap-4">
                            <Select
            ...
            <div className="space-y-6">
                <ComponentCard title="List of Earnings">
                <ListofEarningsTable /> 
                </ComponentCard>
            </div>
      </div>
