...
export default function BeginningBalance() {
  ...
  return (
    <>
      ...
      />
      <PageBreadcrumb pageTitle="Beginning Balance" />
      <div className="space-y-6">
        <div className="space-y-6">
                <ComponentCard title="Search Beginning Balance">
            ...
            <div className="space-y-6">
                <ComponentCard title="List of Beginning Balance">
                <ListofBeginningBalanceTable /> 
                </ComponentCard>
            </div>
      </div>
    </>
...
interface Employee {
 ...
 function ListofBeginningBalanceTable() {
