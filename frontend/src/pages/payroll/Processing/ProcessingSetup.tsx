...
export default function ProcessingSetup() {
  ...
  return (
    <>
      ...
      />
      <PageBreadcrumb pageTitle="Processing Setup" />
      <div className="space-y-6">
        <div className="space-y-6">
                <ComponentCard title="Search Processing Setup">
            ...
            <div className="space-y-6">
                <ComponentCard title="List of Payroll Setup">
                <ListofPayrollSetupTable /> 
                </ComponentCard>
            </div>
      </div>
    </>
...
interface Employee {
 ...
 function ListofPayrollSetupTable() {
